...
# 这段代码从网上复制的，原文地址https://blog.csdn.net/xuan_zizizi/article/details/77870184
# 他也使用了tensorflow官方给的读cifar10数据的接口，就是cifar10.py和cifar10_input.py
##载入库
...
for step in range(max_steps):
    ...
    if step %10 == 0:
        ...
        print("accuracy = %.2f"%(true_count/batch_size))
##测试模型准确率
num_examples = 1000
import math
